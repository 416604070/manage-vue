...
const http = {
     ...
     */
    doGet: function (self, url, param, successFunction, errorFunction) {
        doGet(self, url, param, successFunction, errorFunction, true);
    },
     ...
     * @Param errorFunction 失败回调函数
     */
    doGetCheckParam: function (self, url, param, successFunction, errorFunction) {
        doGet(self, url, param, successFunction, errorFunction, false);
    },
    /**
     ...
     * @Param errorFunction 失败回调函数
     */
    doPostForForm: function (self, url, param, successFunction, errorFunction) {
        doPostForForm(self, url, param, successFunction, errorFunction, true);
    },
    /**
     ...
     * @Param errorFunction 失败回调函数
     */
    doPostCheckParam: function (self, url, param, successFunction, errorFunction) {
        doPostForForm(self, url, param, successFunction, errorFunction, false);
    },
    /**
     ...
     * @Param errorFunction 失败回调函数
     */
    doPostForJson : function (self, url, param, successFunction, errorFunction) {
        doPostForJson(self, url, param, successFunction, errorFunction, true)
    }
 ...
 */
function doGet(self, url, param, successFunction, errorFunction, showErrorMSg) {
    if (showErrorMSg) {
 ...
 * @Param showErrorMSg 是否显示返回的错误信息
 */
function doPostForForm(self, url, param, successFunction, errorFunction, showErrorMSg) {
    if (showErrorMSg) {
        store.commit(types.OPEN_HTTP);
    }
    axios({
 ...
 * @Param showErrorMSg 是否显示返回的错误信息
 */
function doPostForJson(self, url, param, successFunction, errorFunction, showErrorMSg) {
    if (showErrorMSg) {
        store.commit(types.OPEN_HTTP);
    }
    axios({
