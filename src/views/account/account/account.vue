        ...
        <el-dialog :title="accountForm.accountFormTitle" :visible.sync="accountForm.openOrClose" width="60%"
            ...
            <el-form :model="accountForm" :rules="accountFormRules" ref="accountForm">
                ...
                <el-form-item label="用户名" autocomplete="off" prop="username">
                    <el-input type="text" v-model="accountForm.username" clearable auto-complete="off"></el-input>
                </el-form-item>
        ...
        data() {
            ...
            return {
                ...
                pagePermission: {
                    ...
                    AccountAccountUpdatePassword: false,
        ...
        methods: {
            ...
            openOrCloseResetPasswordWindow(value, account) {
                ...
                if (value) {
                    ...
                    this.resetPasswordFrom.account = account;
                    this.resetPasswordFrom.resetPasswordFromTitle = "重置【 " + account.username + " 】密码"
                } else {
                    this.resetPasswordFromRules = {
                        //开关
                        openOrClose: false,
                        //是否检测确认密码
                        isCheckAffirmPassword: false,
                ...
                this.$refs.resetPasswordFrom.validate((valid) => {
                    this.$Http.doPostForForm(
                        ...
                        "account/account/update/password",
                        {
                            ...
                            password: this.$PasswordUtil.getPasswordByBase64(this.resetPasswordFrom.password, this.resetPasswordFrom.account.username),
